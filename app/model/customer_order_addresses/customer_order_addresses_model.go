...
// arModel is a active record design model for table customer_order_addresses operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of customer_order_addresses.
	Table = "customer_order_addresses"
	// Model is the model object of customer_order_addresses.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table customer_order_addresses.
	Columns = struct {
		Id              string //               
        OrderId         string //               
        Firstname       string // 姓            
