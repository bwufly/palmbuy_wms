...
// arModel is a active record design model for table customer_order_products operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of customer_order_products.
	Table = "customer_order_products"
	// Model is the model object of customer_order_products.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table customer_order_products.
	Columns = struct {
		Id                 string //                    
        OrderId            string //                    
        ProductId          string //                    
