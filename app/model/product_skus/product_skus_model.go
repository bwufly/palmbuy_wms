...
// arModel is a active record design model for table product_skus operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of product_skus.
	Table = "product_skus"
	// Model is the model object of product_skus.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table product_skus.
	Columns = struct {
		Id             string // 自增ID        
