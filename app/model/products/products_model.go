...
// arModel is a active record design model for table products operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of products.
	Table = "products"
	// Model is the model object of products.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table products.
	Columns = struct {
		Id                 string // 自增ID                     
        CategoryId         string // 商品所属类目               
        CategoryPath       string // 商品所属类目路径           
        SupplierId         string // 属所门店ID                 
        AuthorId           string // 所属用户ID                 
        StallId            string // 档口ID                     
        Code               string // 货号                       
        Price              string // 售价                       
        ...
        Title              string // 商品名称                   
        EnTitle            string //                            
        MainIcon           string // 商品主图                   
        PicType            string // 图片类型1-正方形 2-长方形  
        Sort               string // 商品排序                   
        Status             string // 1-上架 2-下架 3-待上架     
