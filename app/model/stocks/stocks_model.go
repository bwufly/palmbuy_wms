...
// arModel is a active record design model for table stocks operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of stocks.
	Table = "stocks"
	// Model is the model object of stocks.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table stocks.
	Columns = struct {
		Id                string //                 
        ProductId         string //                 
        SkuId             string //                 
